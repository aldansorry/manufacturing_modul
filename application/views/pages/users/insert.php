                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-4">
                                <input type="text" name="username" class="form-control" id="input-username" value="<?php echo set_value('username') ?>">
                                <?php echo form_error('username') ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="input-password" class="col-sm-2 col-form-label text-right">password</label>
                            <div class="col-sm-8 col-md-4">
